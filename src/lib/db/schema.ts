...
import type { Transaction, Category, Account, RecurringTransaction, Budget, Settings, FixedExpense, PlannedIncome } from '@/types'
...
export class BudgetDatabase extends Dexie {
  ...
  constructor() {
    ...
    this.version(1).stores({
      transactions: '++id, date, type, category, account, [date+category], [date+account], syncStatus, recurringId',
