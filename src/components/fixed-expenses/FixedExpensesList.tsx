...
export function FixedExpensesList({ onEdit }: FixedExpensesListProps) {
  const { expenses, markAsPaid, toggleActive, deleteExpense, getOverdueExpenses } = useFixedExpenses()
                ...
                <div className="flex items-start justify-between">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 mt-1 text-sm text-muted-foreground">
                          ...
                          {expense.lastPaidDate && (
                            <span>Оплачено: {new Date(expense.lastPaidDate).toLocaleDateString('ru-RU')}</span>
                          )}
                        </div>
                        {expense.notes && (
                  ...
                  <div className="flex items-center gap-4">
                    <div className="text-right">
                      <div className="text-xl font-bold">{formatCurrencyRUB(expense.amount)}</div>
